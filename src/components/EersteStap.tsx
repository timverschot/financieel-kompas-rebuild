    ...
    >
      <p className="rij-meta" style={{ margin: 0 }}>
        {/* Noem het scherm bij de naam die er ook echt op staat ("Je situatie"), niet
            ...
            iedereen. */}
        {hier
          ? t('Loop de blokken hieronder door: je rekeningen, je vaste kosten en je abonnementen. Na tien minuten weet je wat er elke maand vastligt en wat je vermogen is — nog vóór je één boeking ingeeft.')

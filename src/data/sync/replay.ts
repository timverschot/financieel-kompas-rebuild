  ...
  for (const r of gesorteerd) {
    ...
    switch (g.type) {
      ...
      case 'overboeking.bewaard':
        staat.overboekingen.set(g.payload.id, g.payload)
        break
      case 'overboeking.verwijderd':
        staat.overboekingen.delete(g.payload.id)
        break
      case 'kind.bewaard':
        staat.kinderen.set(g.payload.id, g.payload)
        break
      ...
      case 'lening.verwijderd':
        staat.leningen.delete(g.payload.id)
        break
      case 'aflossing.bewaard':
        staat.aflossingen.set(g.payload.id, g.payload)
        break
      case 'aflossing.verwijderd':
        staat.aflossingen.delete(g.payload.id)
        break
      case 'garantie.bewaard':
        staat.garanties.set(g.payload.id, g.payload)
        break
      case 'garantie.verwijderd':
        staat.garanties.delete(g.payload.id)
        break
      case 'streepjescode.bewaard':
        staat.streepjescodes.set(g.payload.id, g.payload)
        break
      case 'streepjescode.verwijderd':
        staat.streepjescodes.delete(g.payload.id)
        break
      case 'ordening.bewaard':
        staat.ordeningen.set(g.payload.id, g.payload)
        break
